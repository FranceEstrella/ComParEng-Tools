...
const resolveCanonicalCourseCode = (rawCode = "") => {
  ...
  if (canonicalCourseCodeSet.has(normalized)) return normalized
...
export { initialCourses, curriculumCodes, courseDetailsMap, resolveCanonicalCourseCode, getCourseDetailsByCode }
