...
// Extract just the course codes for filtering
const curriculumCodes = initialCourses.map((course) => course.code)
...
export { initialCourses, curriculumCodes, courseDetailsMap }
