...
export default function CourseTrackerPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-clip bg-gradient-to-br from-sky-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
